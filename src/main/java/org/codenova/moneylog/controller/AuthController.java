...
public class AuthController {
    ...
    public String naverCallbackHandle(@RequestParam("code") String code,
        ...
        if(found != null) {
            ...
            User user = User.builder().nickname(profileResponse.getNickname()).provider("NAVER")
                    .providerId(profileResponse.getId()).picture(profileResponse.getProfileImage()).verified("T").build();
